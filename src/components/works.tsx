...
export default function Works() {
    return(
        <WorksLayout>
            ...
            <Fade delay={150} triggerOnce={true} cascade damping={1e-1}>
                <WorksItem>
            ...
            <Fade delay={250} triggerOnce={true} cascade damping={1e-1}>
                <WorksItem>
            ...
            <Fade delay={500} triggerOnce={true} cascade damping={1e-1}>
                <WorksItem>
                    <WorksH1>Junior Portfolio Template</WorksH1>
                    <WorksButton href="https://cdnverse.netlify.app" target="_blank">Visit Project</WorksButton>
                </WorksItem>
                </Fade>
            <Fade delay={550} triggerOnce={true} cascade damping={1e-1}>
                <WorksItem>
            ...
            <Fade delay={700} triggerOnce={true} cascade damping={1e-1}>
                <WorksItem>
